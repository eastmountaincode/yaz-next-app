...
function BioModal({
  ...
  return (
    <ModalShell onClose={onClose} ariaLabel="Yaslynn Rivera bio" className="w-full max-w-5xl">
      ...
      >
        {bio.image ? (
          <div className="relative aspect-[4/5] w-full bg-black min-[480px]:mx-auto min-[480px]:w-[86%] sm:w-[72%] sm:max-w-md md:mx-0 md:aspect-auto md:min-h-0 md:w-full md:max-w-none">
            <ContentImage
              image={bio.image}
